...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/12/13 15:53:39 by sgalio            #+#    #+#             */
/*   Updated: 2021/12/13 15:53:45 by sgalio           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	get_next_line(int fd, char **line)
{
	...
	if (buf == ((void *)0))
		return (-1);
	while (read_size != 0 && ft_strchr(remainder[fd], '\n') == NULL)
	{
	...
	free(buf);
	return (create_line_and_remainder(line, &remainder[fd]));
}
